...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let evt_id = new_id () in
    evt := {id = evt_id; action = listener} :: !evt;
    evt_id;;
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun e -> e.id = i) (!evt) ;;
(*......................................................................
...
let fake_id = WEvent.add_listener newswire fakeNewsNetwork ;;
let buzz_id = WEvent.add_listener newswire buzzFake ;;
